...
func UpdateContactApplicationHandler(svcCtx *svc.ServiceContext) http.HandlerFunc {
	return func(w http.ResponseWriter, r *http.Request) {
		var req types.UpdateContactApplicationReq
		if err := httpx.Parse(r, &req); err != nil {
			httpx.OkJsonCtx(r.Context(), w, xerr.ErrHandler(xerr.CustomErr(400, r.Context(), err)))
			return
		}

		l := contact.NewUpdateContactApplicationLogic(r.Context(), svcCtx)
		resp, err := l.UpdateContactApplication(&req)
		if err != nil {
