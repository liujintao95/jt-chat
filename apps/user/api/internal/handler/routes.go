...
import (
	...
	auth "jt-chat/apps/user/api/internal/handler/auth"
	contact "jt-chat/apps/user/api/internal/handler/contact"
	group "jt-chat/apps/user/api/internal/handler/group"
	user "jt-chat/apps/user/api/internal/handler/user"
